        ...
        <div className="page-container p-10 flex justify-between">
            <div className="flex flex-col gap-2 w-full md:w-1/3">
                <div className="flex items-center gap-1">
                    ...
                    <Link href="https://xdownloader.shop" target="_blank"><Chip color="danger" size="sm" variant="flat" className="ml-2 -mt-1.5">v{process.env.APP_VERSION}</Chip></Link>
                </div>
                ...
                <p className="text-sm text-gray-500">© 2025 <a href="https://xdownloader.shop" target="_blank">X-Downloader</a> {t('All rights reserved.')}</p>
            </div>
            ...
            <div className="hidden md:flex flex-col gap-4">
                <div>
                    ...
                    <Link href="mailto:support@xdownloader.shop" className="text-sm hover:text-primary mb-4">support@xdownloader.shop</Link>
                    <a href="https://supadr.com?utm_source=xdownloader.shop&utm_medium=badge&utm_campaign=supadr&via=yibo535" target="_blank">
                        <img src="https://supadr.com/api/badge/xdownloader.shop.svg?theme=yellow" alt="Domain Rating for xdownloader.shop" width="280" height="64" />
                    </a>
                </div>
            </div>
        </div>
